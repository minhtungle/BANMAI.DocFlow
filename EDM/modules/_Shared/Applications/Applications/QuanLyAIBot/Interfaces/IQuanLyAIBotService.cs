...
{
    public interface IQuanLyAIBotService
    {
        List<ThaoTac> GetThaoTacs(string maChucNang);
        Task<Index_OutPut_Dto> Index_OutPut();
        #region AIBot
        Task<bool> IsExisted_AIBot(tbAIBot aiBot);
        Task<string> TaoNoiDungAI(TaoNoiDungAI_Input_Dto input);
        Task<string> TestNoiDungAI(TestNoiDungAI_Input_Dto input);
        Task<DisplayModel_CRUD_AIBot_Output_Dto> DisplayModel_CRUD_AIBot_Output(
            DisplayModel_CRUD_AIBot_Input_Dto input);
        Task<DisplayModel_Test_AIBot_Output_Dto> DisplayModel_Test_AIBot_Output(
            Guid input);
        ...
        Task<DisplayModel_CRUD_LoaiAIBot_Output_Dto> DisplayModel_CRUD_LoaiAIBot_Output(
