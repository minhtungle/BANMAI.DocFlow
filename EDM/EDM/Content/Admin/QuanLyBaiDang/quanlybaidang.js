...
class QuanLyBaiDang {
    ...
    init() {
        ...
        quanLyBaiDang.baiDang = {
            ...
            xemChiTiet: function (idBaiDang = '00000000-0000-0000-0000-000000000000') {
                var idBaiDangs = [];
                // Lấy id
                ...
                window.location = `/QuanLyBaiDang/xemChiTiet_BaiDang?idBaiDang=${idBaiDangs[0]}`;
                //$.ajax({
                //    ...ajaxDefaultProps({
                //        url: "/QuanLyBaiDang/xemChiTiet_BaiDang",
                //        type: "GET",
                //        contentType: "application/json; charset=utf-8",
                //        data: { input: idBaiDangs[0] },
                //    }),
                //    //success: function (res) {
                //    //    $("#phantich-tab").html(res);
                //    //}
                //})
            },
            displayModal_CRUD: function (loai = "", idBaiDang = '00000000-0000-0000-0000-000000000000') {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        quanLyBaiDang.handleModal_CRUD.addBanGhi(res.output);
                    }
                })
            },
        ...
        quanLyBaiDang.handleModal_CRUD = {
            ...
            save: function (loai) {
                ...
                $.each($(".baidang-read", $("#baidang-crud")), function () {
                    ...
                    var tepDinhKems = [];
                    $.each($(`#anhmota-items .image-item`, $div), function () {
                    ...
                    var idTaiKhoans = $(`#select-taikhoan-${rowNumber}`, $div).val();
                    var idBaiDang = $(`#input-idbaidang`, $div).val();
                    $.each(idTaiKhoans, function (i, idTaiKhoan) {
                        // Cùng 1 bản ghi nhưng nhiều nền tảng thì chỉ lấy id của bài đăng đầu tiên
                        // Các bài còn lại cho là tạo mới
                        //if (i != 0) idBaiDang = "00000000-0000-0000-0000-000000000000";
                        var baiDang = {
                            RowNumber: rowNumber,
                            BaiDang: {
                                IdBaiDang: idBaiDang,
                ...
                sys.confirmDialog({
                    ...
                    callback: function () {
                        ...
                        var url = "/QuanLyBaiDang/create_BaiDang";
                        //if (loai == "create" || loai == "draft")
                        if (loai == "draftToSave" || loai == "update") url = "/QuanLyBaiDang/update_BaiDang";
                        $.ajax({
                            ...ajaxDefaultProps({
                                url: url,
                                type: "POST",
