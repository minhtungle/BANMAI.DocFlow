    ...
    init() {
        ...
        quanLyAIBot.aiBot = {
            ...
            handleAI: {
                ...
                testNoiDungAI: function (idAIBot = '00000000-0000-0000-0000-000000000000') {
                    var $modal = $("#aibot-test");
                    var input = {
                        IdAITool: $(`#select-aitool`, $modal).val(),
                        IdAiBot: idAIBot,
                        Keywords: $(`#input-keywords-danhap`, $modal).val().trim(),
                    };
                    $.ajax({
                        ...ajaxDefaultProps({
                            url: "/QuanLyAIBot/testNoiDungAI",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            data: { input: input },
                        }),
            ...
            displayModal_Test: function (idAIBot = '00000000-0000-0000-0000-000000000000') {
                var idAIBots = [];
                ...
                $.ajax({
                    ...ajaxDefaultProps({
                        url: "/QuanLyAIBot/displayModal_Test_AIBot",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        data: {
                            input: idAIBots[0]
