...
namespace Applications.QuanLyBenhNhan.Filters
{
    public static class GetBenhNhanFilter
    {
        public static IQueryable<tbBenhNhan> ApplyFilters(
            this IQueryable<tbBenhNhan> q, LocThongTinDto locThongTin, Guid? maDonVi = null)
        {
            // Điều kiện chung
